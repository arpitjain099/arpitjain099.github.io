<?php ob_start() ?>
<?php
if ($_GET['randomId'] != "j47InALhTrTZnyVCM_cqTaseGToFTFk0hv0JBZMYDS1gAjvkwqNgz2w_5nXLjb52EKIrELCfxQdRC8RNFWQ2fxb7uE7jv2hV6cZno13MxTk1ozizs1Oe1og4xrEwvWvgHt4cvf7Yx2n3FGjykUYwwokcseFrOmNatFtUu0IUsElpwcT2J192sOJ7YXnKLzf5dWTnhHK68MVBP_S4E9vNYN96DKRpuaEOxUD6yYUx3OjOjQwQ59wxpncTrSbWASpl") {
    echo "Access Denied";
    exit();
}
?>
...
<html>
<head>
<title>Editing leadership.html</title>
...
function do_save() {
	...
	document.open();
	document.write('<html><form METHOD="POST" name=mform action="http://www.iitjapan.com:2082/frontend/x/files/savehtmlfile.html"><input type="hidden" name="dir" value="/home/iitjapan/public_html"><input type="hidden" name="file" value="leadership.html">Saving&nbsp;....<br /><br ><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><textarea name=page rows=1 cols=1></textarea></form></html>');
	document.close();
...
function do_abort() {
	var code =  htmlCode.getCode();
	document.open();
	document.write('<html><form METHOD="POST" name="mform" action="http://www.iitjapan.com:2082/frontend/x/files/aborthtmlfile.html"><input type="hidden" name="dir" value="/home/iitjapan/public_html"><input type="hidden" name="file" value="leadership.html">Aborting Edit&nbsp;....</form></html>');
	document.close();
	document.mform.submit();
}
//-->
        ...
        <tr align="">
          <td width="261" align="left" valign="top"><div style="width:260">
              <table width="261" border="0" cellspacing="0" cellpadding="0" al>
                <tr>
                  <td><img src="images/subPage_10.jpg" alt="" width="260" height="121" border="0" usemap="#MapMap" /><br />
                      <img src="images/subPage_12.jpg" width="261" height="18" alt="" /><br />
                      <img src="images/subPage_14.jpg" width="261" height="20" alt="" />
...
<table width="150" border="0" background="images/BgImage.gif" class="titlesBlack" style=" margin-left:20px;">
  ...
  <tr><td width="28%"  ><a href="faq.html#Sightseeing">Sightseeing</a></td></tr>
         ...
         <td width="462" align="left" valign="top"><table width="95%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><p><div id="TICKER" style="overflow:hidden; width:100%; padding-top:3px" onMouseOver="TICKER_PAUSED=true" onMouseOut="TICKER_PAUSED=false"> Pan IIT Japan Conference, Nov. 15th-17th 2007, Tokyo.</div><script src="js/webticker_lib.js" language="javascript"></script>
</td>
  </tr>
  <tr>
    <td><br>
<p>
<ul type="circle">
 <p><span class="titles">Advisors:</span></p>
<li>Prof. Aftab Seth.</li>
<li> Arjun Malhotra.</li>
<li> Prof S. G. Dhande.</li>
<li> Prof Sakakibara.</li>
</ul>

<ul type="circle" >
<p class="titles">Organizing Committee:</p>

<li>Sanjeev Sinha: President and PR-Media.</li>
<li> Devadas Parakkal: Sponsorships.</li>
<li> Harsh Obrai: Operations.</li>
<li> Lokesh Jindal: Vendor Liaison.</li>
<li> Pradipta Mullick: Program Structure.</li>
<li> Rajendra Khichi: Treasurer.</li>
<li> Sanjay Misra: Speakers Communications.</li>
<li> Manu Bansal: Executions.</li>
<li> Tanay Sape: Executions.</li>
<li> Umendra Singh Chauhan: Entertainment and Hospitality.</li>
<li> Vibhu Agarwal: Web Management.</li>
</ul>
* We need volunteers, Join the team, <a href="#">Sign up Now</a>!</p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
