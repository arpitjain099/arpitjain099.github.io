...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<nav id="nav-primary" class="navbar navbar-custom" role="navigation">
          <div class="container">
            <div class="navbar-header">
              ...
              <a href="index.html"><img src="img/wwdlogo.svg" alt="logo"></a>
              <!--https://vectr.com/-->
            </div>
				...
				<ul>	
                    ...
                    <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000" data-thumb="img/slide_thumb_1.jpg"  data-saveperformance="off"  data-title="Slide">
                        ...
                        <div class="tp-caption light_heavy_70_shadowed lfb ltt tp-resizeme"
                            ...
                            style="z-index: 2; max-width: auto; max-height: auto; white-space: nowrap;">Preventing workplace abuse
                        </div>
                        <div class="tp-caption light_medium_30_shadowed lfb ltt tp-resizeme"
                            ...
                            data-endspeed="500"
                            data-endeasing="Power4.easeIn"
                            style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;">Handling unwanted advances from colleagues
                        </div>
                    ...
                    <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000" data-thumb="img/slide_thumb_2.jpg"  data-saveperformance="off"  data-title="Slide">
                        ...
                        <div class="tp-caption light_heavy_70_shadowed lfb ltt tp-resizeme"
                            ...
                            data-endspeed="500"
                            data-endeasing="Power4.easeIn"
                            style="z-index: 2; max-width: auto; max-height: auto; white-space: nowrap;">Preventing harassment at home
                        </div>
                        ...
                        <div class="tp-caption light_medium_30_shadowed lfb ltt tp-resizeme"
                            ...
                            data-endspeed="500"
                            data-endeasing="Power4.easeIn"
                            style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;">Be the woman you needed as a girl.
                        </div>
                    </li>
    			</ul>		
                    ...
                    <div class="col-lg-10 col-lg-offset-1 col-md-12 text-center">
                        <div class="row">                        
                            <div class="feature col-lg-4 col-md-4 col-sm-4">
                                <i class="pe-4x pe-7s-info"></i>
                                <h4>Sexual abuse</h4>
                                <p>Prevent unwanted sexual advances from coworkers, family members, friends and acquaintances</p>
                            </div>
                            
                            <div class="feature col-lg-4 col-md-4 col-sm-4">
                                <i class="pe-4x pe-7s-science"></i>
                                <h4>Community Sessions</h4>
                                <p>Let's end the taboo by organizing educational sessions. Become a chapter lead here.</p>
                            </div>
                            
                            <div class="feature col-lg-4 col-md-4 col-sm-4">
                                <i class="pe-4x pe-7s-speaker"></i>
                                <h4>Speak up!</h4>
                                <p>If you have faced harassment at home or at work, please report it to us</p>
                            </div>
                	...
                	<div class="container">
                    	<div class="row">
                        	...
                        	<div class="col-lg-8 col-md-8 col-sm-8">
                                ...
                                <p class="lead">
                        <i class="pe-1x pe-7s-mail"><a href="mailto:womenwhodefendhq@gmail.com" style="color: white; vertical-align: text-top;">womenwhodefendhq@gmail.com</a></i>
                                </p>
                                <p class="lead">
                        <i class="pe-1x pe-7s-phone"><a href="tel:+817043915086" style="color: white; vertical-align: text-top;">+81 70 4391 5086</a></i>
                                </p>
                            </div>
		...
		<!--<div class="container" width="100%">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3244.1328261356075!2d139.74851131464052!3d35.59978998021331!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x601861dda4029133%3A0x268f75a5df086ad!2sYashio-Park+Town!5e0!3m2!1sen!2sjp!4v1484400321621" width="100%" height="300px" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
        -->
        <!-- FOOTER -->        
        <footer id="footer">
