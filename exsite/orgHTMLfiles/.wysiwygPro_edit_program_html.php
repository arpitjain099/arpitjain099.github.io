<?php ob_start() ?>
<?php
if ($_GET['randomId'] != "3ZNys35frwWTnK_ggdBeHvnw6eoOjbPu7PcXwhrCfFFRXFoJoLNOz64o7hvnxBCt5D57SaBNqyStbFPsKQ5WZDtb84kg22BPMpm3apmoJGwldghoNPlY4Vq9Xmj_u6jW9SfslhVnrlyKGmTvgHxlVQmm1v3ciDz3jYc26b4Qr7XYiZLW26E19xxzQcY1xA05xO5BtOg8C4Ka5l9jH5td2QJ9zOfRH9hgd_DhF0hNLl0lZdbPu1ZEOCDxhtWV7JMg") {
    echo "Access Denied";
    exit();
}
?>
...
<html>
<head>
<title>Editing program.html</title>
...
function do_save() {
	...
	document.open();
	document.write('<html><form METHOD="POST" name=mform action="http://www.iitjapan.com:2082/frontend/x/files/savehtmlfile.html"><input type="hidden" name="dir" value="/home/iitjapan/public_html"><input type="hidden" name="file" value="program.html">Saving&nbsp;....<br /><br ><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><textarea name=page rows=1 cols=1></textarea></form></html>');
	document.close();
...
function do_abort() {
	var code =  htmlCode.getCode();
	document.open();
	document.write('<html><form METHOD="POST" name="mform" action="http://www.iitjapan.com:2082/frontend/x/files/aborthtmlfile.html"><input type="hidden" name="dir" value="/home/iitjapan/public_html"><input type="hidden" name="file" value="program.html">Aborting Edit&nbsp;....</form></html>');
	document.close();
	document.mform.submit();
}
//-->
...
<script language="JavaScript" vqp_uid0="163492" vqp_datafile0="./js/new_menu1.js" is_vqp_html="1" vqptag="doc_level_settings">cdd__codebase = "js/";cdd__codebase163492 = "";</script>
...
<tbody>
<tr>
<td valign="top" align="left" width="261" height="800">
...
<img class="expander" id="expander1" height="9" alt="" src=":2082/images/expand.gif" width="9">Â Â Program</a></span> 
...
<td><span style="width: 165px;"><a href=":2082/sponsors.html">
<img class="expander" id="expander2" height="9" alt="" src=":2082/images/collapse.gif" width="9">Â Â SponsorsÂ Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â </a> </span></td></tr>
<tr>
<td>&nbsp;</td>
<td><span style="width: 165px;"><a title="Click to view menu" onfocus="this.blur()" onclick="return toggleProcedure(\'3\')" href="">
<img class="expander" id="expander3" height="9" alt="" src=":2082/images/expand.gif" width="9">Â Â Faq
</img></a></span> 
...
<tr>
<td>&nbsp;</td>
<td><span style="width: 165px;"><a href=":2082/blog.html">
<img class="expander" id="expander2" height="9" alt="" src=":2082/images/collapse.gif" width="9">Â Â BlogÂ Â Â Â Â Â </a>
</img></span></td></tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td></tr>
...
<script language="javascript" type="text/javascript">
				document.write(searchsite);
				  </script>Â </td></tr></tbody></table></div></td>
...
<br></p>
<ul type="disc">
<li><a name="day1"></a>Â <span class="titles">November 15<font color="#660033">&nbsp;</font></span><font color="#660033"><strong>(2pm - 10pm)</strong> </font></li>
<ul>
<li>Academics</li>
<li>Socio-Political Dialogue</li></ul></ul>
<p>&nbsp;</p>
<ul type="disc">
<li><a name="day2"></a>Â <span class="titles">November 16 <font color="#660033">(10am - 10pm)</font></span></li>
<ul>
<li>Commerce and Trade</li>
<li>Manufacturing and Infrastructure</li>
<li>Knowledge Economy</li>
<li>Financial Services</li></ul></ul>
<p>
<br>
<br></p>
<ul type="disc">
<li><a name="day3"></a>Â <span class="titles">November 17 <font color="#660033">(various)</font></span></li>
<ul>
<li>Cultural and sightseeing activities in and around Tokyo, Kyoto, and Osaka areaÂ specially as many of our delegates areÂ on maiden visit to Japan. We also aim to help arrange focused meetings of visiting delegates with appropriate local counterparts for specific businesses. </li></ul></ul>
...
<li>Arjun Malhotra (CEO, HeadStrong) </li>
